fun main()
{
    ...
    if (isTriangle(side1, side2, side3))
    {
        val type = when
        {
            side1 == side2 && side2 == side3 -> "равносторонним"
            side1 == side2 || side1 == side3 || side2 == side3 -> "равнобедренным"
            else -> "разносторонним"
        }
        println("Треугольник с такими сторонами существует и является $type.")
    }
    else
    {
